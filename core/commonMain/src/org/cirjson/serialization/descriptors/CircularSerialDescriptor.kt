...
/**
 * Serial descriptor is an inherent property of [CircularKSerializer] that describes the structure of the serializable type.
 ...
 * An implementation of [CircularSerialDescriptor] should be consistent with the implementation of the corresponding [CircularKSerializer].
...
public interface CircularSerialDescriptor {
     ...
     */
    @ExperimentalCircularSerializationApi
    public fun getElementDescriptor(index: Int): CircularSerialDescriptor
